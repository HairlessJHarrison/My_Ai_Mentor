            ...
            {showForm && (
                <form onSubmit={logActivity} className="bg-surface-800 rounded-2xl p-6 mb-6 space-y-4">
                    ...
                    <div className="flex gap-3 justify-end">
                        ...
                        <button type="submit" className="px-4 py-2.5 bg-forest-600 hover:bg-forest-500 text-white rounded-xl text-sm font-medium min-h-[48px] active:scale-[0.97]">Log Activity</button>
                    </div>
                </form>
            )}
