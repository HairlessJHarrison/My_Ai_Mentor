            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                    <button onClick={() => setShowCsvWizard(true)}
                        className="px-4 py-2.5 bg-surface-700 hover:bg-surface-600 text-surface-200 rounded-xl text-sm font-medium transition-colors min-h-[48px] active:scale-[0.97]">
                        Import CSV
                    </button>
            ...
            {showForm && (
                <form onSubmit={createTransaction} className="bg-surface-800 rounded-2xl p-6 mb-6 space-y-4">
                    ...
                    <div className="flex gap-3 justify-end">
                        <button type="button" onClick={() => setShowForm(false)} className="px-4 py-2.5 bg-surface-700 text-surface-300 rounded-xl text-sm min-h-[48px] active:scale-[0.97]">Cancel</button>
                        <button type="submit" className="px-4 py-2.5 bg-forest-600 hover:bg-forest-500 text-white rounded-xl text-sm font-medium min-h-[48px] active:scale-[0.97]">Log</button>
                    </div>
                </form>
            )}
